...
public class Weather {
     ...
     */
     ...
     public static double fahrenheitToCelsius(double tempInFahrenheight){

        return ((tempInFahrenheight - 32)* 5/9);
     }
     ...
     */
     ...
     public static void printTemperatures(double tempInFahrenheight){
        System.out.println("temp in fahrenheit is: " + tempInFahrenheight);
        System.out.println("temp in celcius is: "+ fahrenheitToCelsius(tempInFahrenheight));
     }
}