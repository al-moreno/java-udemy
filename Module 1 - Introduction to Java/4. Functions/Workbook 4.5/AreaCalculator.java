public class AreaCalculator {
    public static void main(String[] args) {
        ...
        double rectable = areaRectangle(1,2);
        double trianble = areaTriangle(1,2);
    
       

        // Task 7 – Call a function that prints all the areas.
        printAreas(square, rectable, trianble, trianble);
    ...
    public static double areaRectangle(double length, double width) {
        ...
        double areaOfRectagle = length * width;
        return areaOfRectagle;
    }
     ...
     */
     ...
     public static void printAreas(double square, double rectable, double trianble, double circle){
        System.out.println("area of a square is   "+ square);
        System.out.println(" aea of a rectable is   "+ rectable);

        System.out.println(" area of triangl is   "+ trianble);
